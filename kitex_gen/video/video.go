...
type QueryVideoByVideoIdsRequest struct {
	VideoIds []int64 `thrift:"video_ids,1" frugal:"1,default,list<i64>" json:"video_ids"`
}

func NewQueryVideoByVideoIdsRequest() *QueryVideoByVideoIdsRequest {
	return &QueryVideoByVideoIdsRequest{}
}

func (p *QueryVideoByVideoIdsRequest) InitDefault() {
	*p = QueryVideoByVideoIdsRequest{}
}

func (p *QueryVideoByVideoIdsRequest) GetVideoIds() (v []int64) {
	return p.VideoIds
}
func (p *QueryVideoByVideoIdsRequest) SetVideoIds(val []int64) {
	p.VideoIds = val
}

var fieldIDToName_QueryVideoByVideoIdsRequest = map[int16]string{
	1: "video_ids",
}

func (p *QueryVideoByVideoIdsRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_QueryVideoByVideoIdsRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *QueryVideoByVideoIdsRequest) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *QueryVideoByVideoIdsRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryVideoByVideoIdsRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *QueryVideoByVideoIdsRequest) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *QueryVideoByVideoIdsRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("QueryVideoByVideoIdsRequest(%+v)", *p)
}

func (p *QueryVideoByVideoIdsRequest) DeepEqual(ano *QueryVideoByVideoIdsRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *QueryVideoByVideoIdsRequest) Field1DeepEqual(src []int64) bool {
...
type QueryVideoByVideoIdsResponse struct {
	StatusCode int32    `thrift:"status_code,1" frugal:"1,default,i32" json:"status_code"`
	StatusMsg  string   `thrift:"status_msg,2" frugal:"2,default,string" json:"status_msg"`
	VideoList  []*Video `thrift:"video_list,3" frugal:"3,default,list<Video>" json:"video_list"`
}

func NewQueryVideoByVideoIdsResponse() *QueryVideoByVideoIdsResponse {
	return &QueryVideoByVideoIdsResponse{}
}

func (p *QueryVideoByVideoIdsResponse) InitDefault() {
	*p = QueryVideoByVideoIdsResponse{}
}

func (p *QueryVideoByVideoIdsResponse) GetStatusCode() (v int32) {
	return p.StatusCode
}

func (p *QueryVideoByVideoIdsResponse) GetStatusMsg() (v string) {
	return p.StatusMsg
}

func (p *QueryVideoByVideoIdsResponse) GetVideoList() (v []*Video) {
	return p.VideoList
}
func (p *QueryVideoByVideoIdsResponse) SetStatusCode(val int32) {
	p.StatusCode = val
}
func (p *QueryVideoByVideoIdsResponse) SetStatusMsg(val string) {
	p.StatusMsg = val
}
func (p *QueryVideoByVideoIdsResponse) SetVideoList(val []*Video) {
	p.VideoList = val
}

var fieldIDToName_QueryVideoByVideoIdsResponse = map[int16]string{
	1: "status_code",
	2: "status_msg",
	3: "video_list",
}

func (p *QueryVideoByVideoIdsResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_QueryVideoByVideoIdsResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *QueryVideoByVideoIdsResponse) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.StatusCode = v
...
func (p *QueryVideoByVideoIdsResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.StatusMsg = v
...
func (p *QueryVideoByVideoIdsResponse) ReadField3(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *QueryVideoByVideoIdsResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryVideoByVideoIdsResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *QueryVideoByVideoIdsResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("status_code", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.StatusCode); err != nil {
...
func (p *QueryVideoByVideoIdsResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("status_msg", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.StatusMsg); err != nil {
...
func (p *QueryVideoByVideoIdsResponse) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("video_list", thrift.LIST, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.STRUCT, len(p.VideoList)); err != nil {
...
func (p *QueryVideoByVideoIdsResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("QueryVideoByVideoIdsResponse(%+v)", *p)
}

func (p *QueryVideoByVideoIdsResponse) DeepEqual(ano *QueryVideoByVideoIdsResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *QueryVideoByVideoIdsResponse) Field1DeepEqual(src int32) bool {
...
func (p *QueryVideoByVideoIdsResponse) Field2DeepEqual(src string) bool {
...
func (p *QueryVideoByVideoIdsResponse) Field3DeepEqual(src []*Video) bool {
...
type VideoService interface {
	...
	QueryVideoByVideoIds(ctx context.Context, req *QueryVideoByVideoIdsRequest) (r *QueryVideoByVideoIdsResponse, err error)
}
...
func (p *VideoServiceClient) QueryVideoByVideoIds(ctx context.Context, req *QueryVideoByVideoIdsRequest) (r *QueryVideoByVideoIdsResponse, err error) {
	var _args VideoServiceQueryVideoByVideoIdsArgs
	_args.Req = req
	var _result VideoServiceQueryVideoByVideoIdsResult
	if err = p.Client_().Call(ctx, "QueryVideoByVideoIds", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewVideoServiceProcessor(handler VideoService) *VideoServiceProcessor {
	...
	self.AddToProcessorMap("QueryVideoByVideoIds", &videoServiceProcessorQueryVideoByVideoIds{handler: handler})
	return self
}
...
type videoServiceProcessorQueryVideoByVideoIds struct {
	handler VideoService
}

func (p *videoServiceProcessorQueryVideoByVideoIds) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := VideoServiceQueryVideoByVideoIdsArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("QueryVideoByVideoIds", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := VideoServiceQueryVideoByVideoIdsResult{}
	var retval *QueryVideoByVideoIdsResponse
	if retval, err2 = p.handler.QueryVideoByVideoIds(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing QueryVideoByVideoIds: "+err2.Error())
		oprot.WriteMessageBegin("QueryVideoByVideoIds", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("QueryVideoByVideoIds", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *VideoServiceGetVideoFeedArgs) InitDefault() {
	*p = VideoServiceGetVideoFeedArgs{}
}
...
func (p *VideoServiceGetVideoFeedArgs) SetReq(val *FeedRequest) {
	p.Req = val
}
...
func (p *VideoServiceGetVideoFeedArgs) DeepEqual(ano *VideoServiceGetVideoFeedArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *VideoServiceGetVideoFeedArgs) Field1DeepEqual(src *FeedRequest) bool {
...
func (p *VideoServiceGetVideoFeedResult) InitDefault() {
	*p = VideoServiceGetVideoFeedResult{}
}
...
func (p *VideoServiceGetVideoFeedResult) SetSuccess(x interface{}) {
...
func (p *VideoServiceGetVideoFeedResult) DeepEqual(ano *VideoServiceGetVideoFeedResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *VideoServiceGetVideoFeedResult) Field0DeepEqual(src *FeedResponse) bool {
...
type VideoServiceQueryVideoByVideoIdsArgs struct {
	Req *QueryVideoByVideoIdsRequest `thrift:"req,1" frugal:"1,default,QueryVideoByVideoIdsRequest" json:"req"`
}

func NewVideoServiceQueryVideoByVideoIdsArgs() *VideoServiceQueryVideoByVideoIdsArgs {
	return &VideoServiceQueryVideoByVideoIdsArgs{}
}

func (p *VideoServiceQueryVideoByVideoIdsArgs) InitDefault() {
	*p = VideoServiceQueryVideoByVideoIdsArgs{}
}

var VideoServiceQueryVideoByVideoIdsArgs_Req_DEFAULT *QueryVideoByVideoIdsRequest

func (p *VideoServiceQueryVideoByVideoIdsArgs) GetReq() (v *QueryVideoByVideoIdsRequest) {
	if !p.IsSetReq() {
		return VideoServiceQueryVideoByVideoIdsArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *VideoServiceQueryVideoByVideoIdsArgs) SetReq(val *QueryVideoByVideoIdsRequest) {
	p.Req = val
}

var fieldIDToName_VideoServiceQueryVideoByVideoIdsArgs = map[int16]string{
	1: "req",
}

func (p *VideoServiceQueryVideoByVideoIdsArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *VideoServiceQueryVideoByVideoIdsArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServiceQueryVideoByVideoIdsArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VideoServiceQueryVideoByVideoIdsArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewQueryVideoByVideoIdsRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *VideoServiceQueryVideoByVideoIdsArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryVideoByVideoIds_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *VideoServiceQueryVideoByVideoIdsArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *VideoServiceQueryVideoByVideoIdsArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VideoServiceQueryVideoByVideoIdsArgs(%+v)", *p)
}

func (p *VideoServiceQueryVideoByVideoIdsArgs) DeepEqual(ano *VideoServiceQueryVideoByVideoIdsArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *VideoServiceQueryVideoByVideoIdsArgs) Field1DeepEqual(src *QueryVideoByVideoIdsRequest) bool {
...
type VideoServiceQueryVideoByVideoIdsResult struct {
	Success *QueryVideoByVideoIdsResponse `thrift:"success,0,optional" frugal:"0,optional,QueryVideoByVideoIdsResponse" json:"success,omitempty"`
}

func NewVideoServiceQueryVideoByVideoIdsResult() *VideoServiceQueryVideoByVideoIdsResult {
	return &VideoServiceQueryVideoByVideoIdsResult{}
}

func (p *VideoServiceQueryVideoByVideoIdsResult) InitDefault() {
	*p = VideoServiceQueryVideoByVideoIdsResult{}
}

var VideoServiceQueryVideoByVideoIdsResult_Success_DEFAULT *QueryVideoByVideoIdsResponse

func (p *VideoServiceQueryVideoByVideoIdsResult) GetSuccess() (v *QueryVideoByVideoIdsResponse) {
	if !p.IsSetSuccess() {
		return VideoServiceQueryVideoByVideoIdsResult_Success_DEFAULT
	}
	return p.Success
}
func (p *VideoServiceQueryVideoByVideoIdsResult) SetSuccess(x interface{}) {
	p.Success = x.(*QueryVideoByVideoIdsResponse)
}

var fieldIDToName_VideoServiceQueryVideoByVideoIdsResult = map[int16]string{
	0: "success",
}

func (p *VideoServiceQueryVideoByVideoIdsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *VideoServiceQueryVideoByVideoIdsResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServiceQueryVideoByVideoIdsResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *VideoServiceQueryVideoByVideoIdsResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewQueryVideoByVideoIdsResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *VideoServiceQueryVideoByVideoIdsResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryVideoByVideoIds_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *VideoServiceQueryVideoByVideoIdsResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *VideoServiceQueryVideoByVideoIdsResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VideoServiceQueryVideoByVideoIdsResult(%+v)", *p)
}

func (p *VideoServiceQueryVideoByVideoIdsResult) DeepEqual(ano *VideoServiceQueryVideoByVideoIdsResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *VideoServiceQueryVideoByVideoIdsResult) Field0DeepEqual(src *QueryVideoByVideoIdsResponse) bool {
