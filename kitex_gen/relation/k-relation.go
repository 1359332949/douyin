...
func (p *IsFollowResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *IsFollowResponse) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *IsFollowResponse) field3Length() int {
	l := 0
