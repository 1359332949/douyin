...
func (p *UserLogin) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserLogin[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *UserLogin) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *UserLogin) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *UserLogin) FastWrite(buf []byte) int {
	return 0
}

func (p *UserLogin) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "UserLogin")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *UserLogin) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("UserLogin")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *UserLogin) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserLogin) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserLogin) field1Length() int {
	l := 0
...
func (p *UserLogin) field2Length() int {
	l := 0
