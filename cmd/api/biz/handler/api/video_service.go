...
func PublishAction(ctx context.Context, c *app.RequestContext) {
	...
	log.Println("--------------------","video"+ VideoName,"---------", localFileName_video,"-------------------------------")
	if err != nil {
	...
	err = rpc.PublishAction(context.Background(), &video.PublishActionRequest{
		UserId:  u.(*api.User).ID,
		// Token: c.PostForm("token"),
		Title: title,
		
		FileUrl: "http://127.0.0.1:8080" + video_path,
		CoverUrl: "http://127.0.0.1:8080" + cover_path,
	})
	if err != nil {
		SendResponse(c, errno.ConvertErr(err), nil)
		return
...
func PublishList(ctx context.Context, c *app.RequestContext) {
	...
	videos, err := rpc.PublishList(context.Background(), &video.PublishListRequest{
...
func GetVideoFeed(ctx context.Context, c *app.RequestContext) {
	...
	feed, err := rpc.GetVideoFeed(ctx,&video.FeedRequest{
		UserId: user_id,
